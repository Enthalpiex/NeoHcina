...
import 'package:xs/src/utils/user_state.dart';
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: Container(
                                  width: 50,
                                  height: 50,
                                  color: isLoggedIn && userInfo != null 
                                      ? ColorUtil.fromHex(userInfo['color'] ?? '#666666')
                                      : Colors.grey,
                                  child: isLoggedIn && userInfo != null && userInfo['avatar'] != null
                                      ? Image.network(
                                          userInfo['avatar'],
                                          fit: BoxFit.cover,
                                          errorBuilder:
                    ...
                    SettingsCard(
                      child: Column(
                        ...
                        children: [
                          ...
                          if (isLoggedIn) AppStyle.divider,
                          SettingsAction(
                            title: '外观设置',
                            onTap: () {
